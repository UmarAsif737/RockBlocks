      ...
      <section class="cards___section position-relative">
        <div class="container">
          ...
          <div class="row p-xl-3 mt-lg-5 mt-4 justify-content-center d-lg-block d-none">
            <div>
              <div
                class=" col-12 d-flex gap-xxl-5 card__1__section gap-md-4 position-relative mx-1"
              ...
              <div
                class=" mt-5 col-12 d-flex gap-xxl-5 card__2__section position-relative gap-md-4 mx-1"
                style={{ justifyContent: 'space-around' }}
              >
            ...
            >
              <SwiperSlide key={0}>
                <div class="swiper-slide " style={{ display: 'flex' }}>
                  <div
                    class=" col-12 d-flex gap-xxl-5 card__1__section gap-md-4 position-relative mx-1 small"
              ...
              <SwiperSlide key={1}>
                <div class="swiper-slide " style={{ display: 'flex' }}>
                  <div
                    class=" col-12 d-flex gap-xxl-5 card__1__section gap-md-4 position-relative mx-1 small small1"
                    style={{ justifyContent: 'space-evenly' }}
                  >
                    <div class="card__box card__yellow__home" id="card__1">
                      <div class="card__img">
          ...
          <div
            className="d-lg-none d-block rare_title_position"
          ...
          <div>
            <div
              class="swiper-button-prev swiper-button-prev-1 prev-button-2 d-lg-none d-block"
              style={{ marginTop: '-7px' }}
            >
              <img src="/assets/images/arrow-left_red.png" alt="image" />
            </div>
            <div
              class="swiper-button-next swiper-button-next-1 next-button-2 d-lg-none d-block"
              style={{ marginTop: '-7px' }}
            >
